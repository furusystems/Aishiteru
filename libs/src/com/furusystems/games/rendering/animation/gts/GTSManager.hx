...
import com.furusystems.games.rendering.animation.characters.AnimPackage;
import com.furusystems.games.rendering.animation.characters.Character;
import com.furusystems.system.threads.GTSLoadWorker;
...
class GTSManager 
{
	...
	public function load(path:String):Void {
		processes.push(new GTSLoadWorker(path));
	}
