package com.furusystems.games.rendering.fonts;
...
class BitmapFont
{
	...
	public var charMap:Array<Character>;
	public var cache:Map<String, Array<Float>>;
	//public var charMap:Map<Int, Character>;
	...
	public var spacing:String; // somehow, removing this causes the build to fail? //Thats because it is a property set in the fnt file: It needs a place to go
	...
	private function setProperty(ob:Dynamic, key:String, value:String):Void	{
	...
	private function processChar(s:String):Void
	{
